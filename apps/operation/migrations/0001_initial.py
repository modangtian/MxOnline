# Generated by Django 2.0.2 on 2018-04-09 12:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='operation.UserAsk', verbose_name='用户咨询')),
            ],
            options={
                'verbose_name': '用户收藏',
